import css from './downloadModal.component.css';
import template from './downloadModal.component.html';
...
export class DownloadModalComponent extends HTMLElement {
...
window.customElements.define('download-modal', DownloadModalComponent);

declare global {
  interface HTMLElementTagNameMap {
    'download-modal': DownloadModalComponent;
  }
}
